    ...
    <>
      <nav className="flex items-center justify-start relative h-12 border-b-2 border-b-teal-600">
        ...
        <ul className=" w-full flex flex-row justify-center font-medium text-sm ">
            ...
            <NavButton label="Families" opt={["Calendari escolar", 'Llibres de text', 'Pagament', 'Plataforma alexia', 'Família i Escola', "Bloc de l'AMPA", 'Quota de materials i serveis', 'Ordinadors portatils', 'Activitats nàutiques']}></NavButton>
